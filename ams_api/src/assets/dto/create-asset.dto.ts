import { IsString, IsNotEmpty, IsOptional, IsNumber, IsDateString, IsUUID, IsIn } from 'class-validator';
import { ApiProperty, ApiPropertyOptional } from '@nestjs/swagger';

export class CreateAssetDto {
    @ApiPropertyOptional({ description: 'System generated tag ID (e.g., HISP-RW-001)' })
    @IsOptional()
    @IsString()
    tag_id?: string;
    ...
    @ApiProperty({ enum: ['IN_STOCK', 'ASSIGNED', 'BROKEN', 'MISSING', 'DISPOSED'] })
    @IsString()
