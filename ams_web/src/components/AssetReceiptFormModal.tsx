  ...
  return (
    <>
      <div
        ...
        onClick={onClose}
      />
      <div className="fixed inset-y-4 inset-x-4 md:inset-x-auto md:right-4 md:w-[850px] bg-white rounded-[2.5rem] shadow-2xl z-[70] flex flex-col overflow-hidden animate-in slide-in-from-right-8 duration-500 border border-white/20">
        ...
        <div className="flex-1 overflow-y-auto p-12 space-y-12 bg-[#fafbfd] print:bg-white print:p-0">
          <div className="flex justify-between items-center max-w-2xl mx-auto print:hidden bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            {steps.map((step, idx) => (
              <div
                key={idx}
                ...
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all duration-500 ${
                    step.completed
                      ...
                      : step.active
                        ? 'bg-orange-500 border-orange-500 text-white shadow-[0_0_15px_rgba(255,128,0,0.3)] animate-pulse'
          ...
          <div className="bg-white p-12 rounded-[2rem] border border-slate-200 shadow-xl max-w-4xl mx-auto space-y-10 relative overflow-hidden print:shadow-none print:border-none print:p-0 print:rounded-none">
            {assignment.form_status !== 'APPROVED' && (
                ...
                <table className="w-full border-collapse">
                  ...
                  <tbody>
                    <tr className="text-slate-800">
                      <td className="px-4 py-4 text-sm font-bold border-r border-slate-900 text-center">
                        01
                      </td>
                      <td className="px-4 py-4 text-sm font-bold border-r border-slate-900">
                        {assignment.asset?.name}
                      </td>
                      <td className="px-4 py-4 text-sm font-bold border-r border-slate-900 font-mono tracking-wider">
                        {canEdit ? (
                          <input
                            type="text"
                            value={serial}
                      ...
                      <td className="px-4 py-4 text-sm font-bold font-mono tracking-wider bg-slate-50">
                        {canEdit ? (
                          <input
                            type="text"
                            value={tagId}
              ...
              <div className="bg-slate-50 p-4 border border-slate-200 rounded-xl">
                ...
                {canEdit ? (
                  <textarea
                    ...
                    className="w-full text-sm font-medium text-slate-600 italic bg-white border border-slate-200 rounded-lg p-2 outline-none focus:border-orange-500"
                    rows={2}
                  />
                ) : (
            ...
            <div className="bg-slate-900 p-8 rounded-[1.5rem] text-white space-y-4 relative overflow-hidden">
              ...
              <div className="space-y-4">
                <div className="h-24 flex items-end justify-center border-b-2 border-slate-900 relative">
                  ...
                  {assignment.user_signed_at && (
                    <div className="absolute top-0 right-0 text-[8px] font-black text-emerald-500 uppercase bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-100 flex items-center gap-1 shadow-sm">
            ...
            <div className="p-8 border-t border-slate-100 bg-white flex flex-col gap-6 shadow-[0_-10px_30px_rgba(0,0,0,0.03)] z-20">
              <div className="space-y-3">
                ...
                <input
                  ...
                  className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-orange-500/10 focus:border-orange-500 text-lg font-['Dancing_Script',_cursive] transition-all placeholder:font-sans placeholder:text-sm"
                />
                <p className="text-[10px] font-bold text-slate-400 italic">
                  By typing your name above, you are creating a legally binding
                  digital signature to the declaration above.
                </p>
              </div>
              <button
            ...
            {showRejectionForm ? (
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <button
                  ...
                  className="py-5 bg-[#ff8000] hover:bg-orange-600 text-white font-black text-xs uppercase tracking-[0.2em] rounded-2xl shadow-[0_15px_30px_-10px_rgba(255,128,0,0.4)] transition-all flex items-center justify-center gap-3 active:scale-95"
                >
        ...
        {(assignment.form_status === 'APPROVED' ||
          (isAdmin && assignment.form_status === 'PENDING_USER_SIGNATURE')) && (
