        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-5 py-2.5 bg-[#ff8000] text-white rounded-xl font-semibold text-[9px] uppercase tracking-widest transition-all shadow-[0_8px_16px_-6px_rgba(255,128,0,0.4)] hover:bg-orange-600 flex items-center gap-2 group active:scale-95"
            >
                    ...
                    >
                      ...
                      <td className="px-8 py-6">
                        <div className="flex flex-col gap-2">
                          <span className="text-[10px] font-semibold text-slate-700 flex items-center gap-2 uppercase tracking-widest">
                      ...
                      <td className="px-8 py-6">
                        <div className="flex flex-col gap-2">
                          ...
                          <span className="text-[9px] font-semibold text-[#ff8000] uppercase tracking-widest flex items-center gap-2">
                      ...
                      <td className="px-8 py-6">
                        <div className="flex flex-col">
                          ...
                          <span className="text-[9px] font-semibold text-slate-300 uppercase tracking-widest mt-0.5 font-sans">
                            Cost:{' '}
