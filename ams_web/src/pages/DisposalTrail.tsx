        ...
        <>
          ...
          <div className="flex justify-end mb-4">
            <button
              ...
              disabled={disposedAssets.length === 0}
              className="bg-white border border-slate-200 text-slate-600 px-4 py-2 rounded-xl font-bold hover:bg-slate-50 transition-all flex items-center gap-2 shadow-sm text-xs disabled:opacity-50 disabled:cursor-not-allowed"
            >
