                ...
                <tbody className="divide-y divide-slate-50">
                      ...
                      >
                        ...
                        <td className="px-8 py-5">
                          <div className="flex flex-col">
                            <span className="text-sm font-semibold text-slate-700">
                              {categoryAssetsCount[cat.id] || 0} Assets
                            </span>
                            <span className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest mt-0.5">
                              Registered Units
                            </span>
                        ...
                        <td className="px-8 py-5">
                          <div className="flex items-center gap-2">
                            <div className="px-2 py-1 bg-emerald-50 text-emerald-600 rounded-md text-[10px] font-semibold border border-emerald-100">
                        ...
                        <td className="px-8 py-5">
                          <div className="flex items-center gap-2">
                            <div className="px-2 py-1 bg-slate-50 text-slate-600 rounded-md text-[10px] font-semibold border border-slate-100">
                  ...
                  {uncategorizedCount > 0 && isAdmin && (
                    <tr
                      ...
                      className="bg-orange-50/30 hover:bg-orange-50/50 transition-colors cursor-pointer group border-t-2 border-dashed border-orange-100"
                    >
                      <td className="px-8 py-5">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex flex-col">
                            ...
                            <span className="text-[10px] font-semibold text-orange-400 uppercase tracking-widest mt-0.5">
                              Action Required
                            </span>
                          </div>
                        </div>
                      ...
                      <td className="px-8 py-5" colSpan={3}>
                        <p className="text-xs font-medium text-orange-700/70 italic">
                          {uncategorizedCount} assets found without a valid
                          category assignment.
                        </p>
                      </td>
                      <td className="px-8 py-5 text-right">
                        <span className="text-[10px] font-semibold text-orange-500 uppercase tracking-widest group-hover:translate-x-1 transition-transform inline-block">
                          Reconcile Records &rarr;
                        </span>
                      </td>
                    </tr>
                  )}
    ...
    <div className="flex flex-col h-full">
      <div className="mb-5">
        <button
          ...
          className="flex items-center gap-2 text-xs font-semibold text-slate-500 hover:text-[#ff8000] transition-colors mb-3 group"
        >
          ...
          <div className="flex items-center gap-2">
            {isAdmin && (
              <button
                ...
                className="bg-white border border-slate-200 text-slate-600 px-3 py-2 rounded-xl font-semibold hover:bg-slate-50 transition-all flex items-center gap-2 shadow-sm text-xs"
            ...
            {!isCEO && (
              <button
                ...
                className="bg-[#ff8000] hover:bg-[#e49f37] text-white px-4 py-2 rounded-xl font-semibold shadow-[0_8px_16px_-6px_rgba(255,128,0,0.4)] transform active:scale-95 transition-all flex items-center gap-2 group text-sm"
              >
